...
public class DatabaseConnection {
    ...
    public static void initializeDatabase() {
        try {
            ...
            stmt.executeUpdate("CREATE TABLE IF NOT EXISTS seances(id INTEGER PRIMARY KEY, viewableid INTEGER NOT NULL, roomid INTEGER NOT NULL, version text NOT NULL, time DATETIME NOT NULL, CONSTRAINT viewableidfk FOREIGN KEY (viewableid) REFERENCES viewable(id) CONSTRAINT roomidfk FOREIGN KEY (roomid) REFERENCES rooms(id))");
